...
#         """Extract relevant portion of text around field information"""
#         if not section_text:
#             return ""
...
#         except Exception as e:
#             logging.error(f"Error getting excerpt: {str(e)}")
...
#             except Exception as e:
#                 error_msg = f"Error saving file for user {self.user_id}: {str(e)}"
#                 logging.error(error_msg)
#                 return None
#         return None
...
#         """Process both files simultaneously and extract information"""
...
#                                         # Store results
#                                         results['ppa'][section_key][field] = ppa_info
#                                         results['cycle3'][section_key][field] = cycle3_info
